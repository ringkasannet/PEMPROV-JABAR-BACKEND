...
exports.bumdRouter.get("/getAllBUMD", async (req, res) => {
...
exports.bumdRouter.post("/getBUMDCandidate/:num", async (req, res) => {
...
exports.bumdRouter.post("/evaluasiBUMD/:bumdId/:model", async (req, res) => {
