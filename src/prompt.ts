...
export function createPrompt(query: string, bumd: BUMD) {
    return `
...
export function asetPrompt(query: string, sources: any[]) {
    // console.log(sources);
    return `
...
export function asetPromptDummy(query: string, sources: any[]) {
    return `
...
export function getAsetExtractorPrompt() {
  return `
